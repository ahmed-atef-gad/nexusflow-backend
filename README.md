...
See [.env](.env) for an example used in development.
...
If you want, I can add a `.env.example` and a GitHub Actions workflow for CI.// filepath: README.md
...
If you want, I can add a `.env.example` and a GitHub Actions workflow for CI.
